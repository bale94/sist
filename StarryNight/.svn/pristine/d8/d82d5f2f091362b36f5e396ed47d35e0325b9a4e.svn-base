...
<a href="#"><img src="${path}/TeamProjectCSS/LOGO.png" style=width:250px;height:150px;/></a>
<ul align="center">
<li>
<div class="dropdown">
...
<main>
	...
	<div class="jumbotron text-center">
	  <h2 data-toggle="modal" data-target="#exampleModalCenter">이벤트</h2>
	</div>
	<div class="container">
	    ...
	    <tbody>
	    	<c:forEach var="ev" items="${eventList}">
		       <tr>
		       	   <td>${ev.eventNo}</td>
		       	   <td>${ev.eventTitle}</td>
		       	   <td>${ev.eventRegDate}</td>
		       	   <td>${ev.eventStDate} ~ ${ev.eventDueDate}</td>
		       </tr>
	    	</c:forEach>
	    </tbody>
	   </table>    
