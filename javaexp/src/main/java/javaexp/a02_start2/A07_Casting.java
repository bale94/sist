	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 2. 종류
		 	...
		 	수동(명시적)타입변환 : casting
		 3. 자동(묵시적)타입변환
		 	작은 데이터유형에서 큰 데이터 유형으로 변환할 때는 추가 코드없이 자동으로 할당이 된다
		...
		//앞에 문자열의 영향을 받아 묵시적으로 숫자가 문자열로 변환되어
		// 25 ==> "25"
		// 홍길동2525
		...
		/*
		 4. 명시적 형변환
		 	1) ()을 활용하여 특정한 데이터유형으로 변경이 명시적으로 필요할때 사용한다.
		 	2) 유형
		 		큰데이터형 ==> 작은데이터형
		 		int num01 = (int)25.27;
		 		작은데이터 ==> 큰데이터형
		 		...
		 		double result = num02/(double)num03;  -> 3.333333..
		 		double result = num02/num03; -> 3.0
		 	cf) 자바에서는 정수형과 정수형의 나눗셈은 정수형으로만 산출된다.
		...
		/*
		 ...
		 할당하세요
		 ex2) 소고기 600g을 7등분을 하되 소숫점 이하의 결과까지 출력처리하세요.
		 * */
		byte appleCnt = 40;
		byte bananaCnt = 15;
		// +(연산자)가 들어가면 int형을 필요로한다. 
		int Cnt = appleCnt + bananaCnt;
		System.out.println(Cnt);
		
		double beef = 600/(double)7;
